...
namespace EventsApp.Data.Migrations
{
    ...
    [Migration("20220112114146_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CategorieEvenement", b =>
                {
                    ...
                    b.Property<int>("EvenementsEvenementId")
                        .HasColumnType("int");

                    b.HasKey("CategoriesCategorieId", "EvenementsEvenementId");

                    b.HasIndex("EvenementsEvenementId");
            ...
            modelBuilder.Entity("CategorieEvenement", b =>
                {
                    b.HasOne("EventsApp.Entities.Categorie", null)
                        .WithMany()
                        .HasForeignKey("CategoriesCategorieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EventsApp.Entities.Evenement", null)
                        .WithMany()
                        .HasForeignKey("EvenementsEvenementId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
